...
winBox.addEventListener("mousemove",changeCursor,false);
...
(function(){
    ...
    winBox.addEventListener("mousedown",dragStart,false);
    winBox.addEventListener("mousemove",dragMove,false);        
    winBox.addEventListener("mouseup",dragEnd,false);
})();
...
function changeCursor(e) {
    var x1 = parseInt(this.offsetLeft);
    var y1 = parseInt(this.offsetTop);
    var x2 = x1 + parseInt(this.offsetWidth);
    var y2 = y1 + parseInt(this.offsetHeight);    
    var x = parseInt(e.clientX);    
    var y = parseInt(e.clientY);  
    console.log('1', x1, y1, '2', x2, y2, '0',  x, y);
    if ( (y > y1) && (y < y2) ) {
        console.log('左边缘');
        //鼠标在左边缘
        if (x == x1) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!./JSTask6.css", function() {
			var newContent = require("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!./JSTask6.css");
